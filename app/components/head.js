...
const defaultKeywords = ['gabriel lima', 'front-end', 'angular', 'html5', 'css3', 'web design', 'back-end', 'angularjs'];
const defaultDescription = 'Gabriel Lima - Web Developer';
const defaultOgImage = 'http://www.gabrielima.com/img/gabrielima.jpg';
